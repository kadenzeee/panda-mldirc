...
where the .pkl files are generated by convert_gnn.py.
'''
...
if __name__ == "__main__":
    ...
    parser.add_argument('-b', '--batch', type=bool, required=True, help='Load .pkl inputs in batch mode (0) or single file mode (1)')
